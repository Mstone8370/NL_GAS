...
// Player Stat Tag
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stat_Fire);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stat_Hit);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stat_Hit_Critical);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stat_Kill);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stat_Death);

// Round State Tag
UE_DECLARE_GAMEPLAY_TAG_EXTERN(RoundState_WaitingToStart);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(RoundState_RoundIntro);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(RoundState_InProgress);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(RoundState_End);
